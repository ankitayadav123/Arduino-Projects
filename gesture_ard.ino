...
void loop()
{
  ...
  if(distance2<=25 && distance2>=5) // once if we placed our hands in front of the right sensor in the range between 15 to 35cm this condition becomes true.
  { 
    ...
    find_distance();
    if(distance2<=25 && distance2>=5) // this condition will true if we place our hand in front of the right sensor for more then 300 milli seconds. 
    {
     temp=distance2;                         // store the current position of our hand in the variable temp. 
     while(distance2<=80 && distance2>0)    // this loop will run untill we removes our hand in front of the right sensor.
     {
  ...
  else if(distance1<=25 && distance1>=5)   // once if we placed our hands in front of the left sensor in the range between 15 to 35cm this condition becomes true.
  { 
    ...
    {
       find_distance();
       if(distance2<=25 && distance2>=5)  // if our hand detects in the right sensor before 300 milli seconds this condition becomes true. ( usually it happens if we swipe our hand from left to right sensor )
       {
    ...
    while(distance1<=25 && distance1>=5) // this loop will rotate untill we removes our hand infront of the left sensor. this will avoid not to enter this if condition again.
    find_distance();                      
    }
